...
import { IncomeExpendeturTableComponent } from '../income-expendetur-table/income-expendetur-table.component';
...
@Component({
  selector: 'view-data',
  standalone: true,
  imports: [MaterialModule, MonthNamePipe, IncomeExpendeturTableComponent, NumberConversionAddSymbolPipe],
...
export class ViewDataComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.apiService.getMonthlyTransaction().subscribe({
      next: (res: MonthlyTransaction[]) => {
        console.log(res);
        this.data = res;
